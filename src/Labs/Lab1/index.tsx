        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Boil the eggs.</li>
                    <li>Smash the boiled eggs.</li>
                    <li>Add mayonnaise, mustard, and salt.</li>
                    <li>Mix the added ingredients with the smashed egg.</li>
                    <li>Store in the fridge for 30 minutes.</li>
                    <li>Serve and enjoy!</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input type="text" id="wd-text-fields-first-name" placeholder="John" title="The First Name" /> <br />
                    {/* Last name */}
